...
BEGIN
	...
	INSERT INTO user (`id` , `first_name`, `surname`, `mail`, `hash`)
		VALUES (login, in_first_name, in_surname, in_mail, hash);
...
CALL create_worker('bros', 'Oto', 'Bros', 'obros@example.com', 'jfairfield@example.com', 'manager', 'hash'); # No common workers

CALL create_worker('urbova', 'Helena', 'Urbová', 'hurbova@example.com', 'mmorgan@example.com', 'manager', 'hash');
CALL create_worker('tousel', 'Wendell', 'Tousel', 'wtousel@example.com', 'mmorgan@example.com', 'manager', 'hash');
CALL create_worker('kolicka', 'Mária', 'Kolická', 'mkolicka@example.com', 'mmorgan@example.com', 'manager', 'hash');
...
CALL create_worker('mobler', 'Marek', 'Mobler', 'mmobler@example.com', 'jzrubnova@example.com', 'common_worker', 'hash');
CALL create_worker('dobry', 'David', 'Dobrý', 'ddobry@example.com', 'jzrubnova@example.com', 'common_worker', 'hash');

CALL create_worker('goralova', 'Adriana', 'Goralová', 'agoralova@example.com', 'akovarcik@example.com', 'common_worker', 'hash');

CALL create_worker('nelmer', 'Wayne', 'Nelmer', 'wnelmer@example.com', 'hurbova@example.com', 'common_worker', 'hash');
CALL create_worker('obertova', 'Elena', 'Obertová', 'eobertova@example.com', 'hurbova@example.com', 'common_worker', 'hash');
CALL create_worker('zilava', 'Jana', 'Žilavá', 'jzilava@example.com', 'hurbova@example.com', 'common_worker', 'hash');

CALL create_worker('gatesee', 'William', 'Gatesee', 'wgatesee@example.com', 'wtousel@example.com', 'common_worker', 'hash');
CALL create_worker('borg', 'Venus', 'Borg', 'wborg@example.com', 'wtousel@example.com', 'common_worker', 'hash');
CALL create_worker('tougley', 'Jillian', 'Tougley', 'jtougley@example.com', 'wtousel@example.com', 'common_worker', 'hash');
CALL create_worker('zlevsky', 'Šimon', 'Zlevský', 'szlevsky@example.com', 'wtousel@example.com', 'common_worker', 'hash');
CALL create_worker('novak', 'Ján', 'Novák', 'jnovak@example.com', 'wtousel@example.com', 'common_worker', 'hash');

CALL create_worker('novak2', 'Ján', 'Novák', 'jnovak2@example.com', 'mkolicka@example.com', 'common_worker', 'hash');
CALL create_worker('ligot', 'Adam', 'Ligot', 'aligot@example.com', 'mkolicka@example.com', 'common_worker', 'hash');
CALL create_worker('ducka', 'Renáta', 'Ducká', 'rducka@example.com', 'mkolicka@example.com', 'common_worker', 'hash');
CALL create_worker('titto', 'Aurel', 'Titto', 'atitto@example.com', 'mkolicka@example.com', 'common_worker', 'hash');
CALL create_worker('golem', 'František', 'Golem', 'fgolem@example.com', 'mkolicka@example.com', 'common_worker', 'hash');

CALL create_worker('mackley', 'Torina', 'Mackley', 'tmackley@example.com', 'bcalloway@example.com', 'common_worker', 'hash');
CALL create_worker('ridley', 'Davina', 'Ridley', 'dridley@example.com', 'bcalloway@example.com', 'common_worker', 'hash');
...
CALL create_customer('ridley2', 'Barbara', 'Ridley', 'bridley@contoso.com', 'Contoso', 'hash');

CALL create_customer('mckeen', 'Elizabeth', 'McKeen', 'elizabeth.mckeen@rencomp.com', 'Renowned Company', 'hash');

CALL create_customer('su', 'Chen', 'Su', 'chen.su@avrgprdcts.cn', 'Average Products', 'hash');
CALL create_customer('jian', 'Li', 'Jian', 'li.jian@avrgprdcts.cn', 'Average Products', 'hash');

CALL create_customer('patoprsty', 'Peter', 'Pätoprstý', 'peter@goliath.sk', 'GOLIATH, s.r.o.', 'hash');

CALL create_customer('bean', 'Paul', 'Bean', 'bean@it.bapts.com', 'Blissful Apartments', 'hash');
CALL create_customer('geeslow', 'Howard', 'Geeslow', 'geeslow@it.bapts.com', 'Blissful Apartments', 'hash');
CALL create_customer('clowken', 'Cane', 'Clowken', 'clowken@it.bapts.com', 'Blissful Apartments', 'hash');

CALL create_customer('aileen', 'Dean', 'Aileen', 'aileen@5coders.com', '5CODERS', 'hash');
CALL create_customer('brock', 'Nina', 'Brock', 'brock@5coders.com', '5CODERS', 'hash');
CALL create_customer('peery', 'Clara', 'Peery', 'peery@5coders.com', '5CODERS', 'hash');
CALL create_customer('plow', 'Pierre', 'Plow', 'plow@5coders.com', '5CODERS', 'hash');

CALL create_customer('kraubacherova', 'Jolana', 'Kraubacherová', 'jkraub@pohadkovepostele.cz', 'Pohádkové postele, spol. s.r.o.', 'hash');
CALL create_customer('spiz', 'Eduard', 'Spíž', 'espiz@pohadkovepostele.cz', 'Pohádkové postele, spol. s.r.o.', 'hash');
